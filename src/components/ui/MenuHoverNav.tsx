...
const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    dropdown: [
      ...
      { label: 'Yael Adler', href: '/magazin/promi-yael-adler', description: 'Hautärztin & Bestseller' },
      { label: 'Doc Esser', href: '/magazin/promi-doc-esser', description: 'WDR Gesundheits-Check' },
      { label: 'Anne Fleck', href: '/magazin/promi-anne-fleck', description: 'Ernährungs-Doc NDR' },
      { label: 'Johannes Wimmer', href: '/magazin/promi-johannes-wimmer', description: 'Doctor Johannes' },
      { label: 'Carsten Lekutat', href: '/magazin/promi-carsten-lekutat', description: 'Hausarzt MDR' },
    ],
  },
